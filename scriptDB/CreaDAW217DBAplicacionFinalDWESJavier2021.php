...
<html>
    <head>
        <meta charset="UTF-8">
        <title>CreaDAW217DBAplicacionLoginLogoffMulticapaPOO</title>
    </head>
    <body>
         ...
         *   @since: 14/01/2021
         *   CreaDAW217DBAplicacionLoginLogoffMulticapaPOO

        */ 
            require_once '../config/configDB.php';
            echo "<h2>CreaDAW217DBAplicacionLoginLogoffMulticapaPOO</h2>";
