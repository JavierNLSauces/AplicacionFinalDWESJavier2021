...
if ($entradaOK) { // si la entrada esta bien recojo los valores introducidos y hago su tratamiento
    ...
    $_SESSION['usuarioDAW217AplicacionFinal'] = $aDatosUsuario[0]; // guarda en la session el objeto usuario
    $_SESSION['fechaHoraUltimaConexionAnterior'] = $aDatosUsuario[1]; // guarda en la session la fechaHoraUltimaConexion del usuario
